...
namespace WMSSolution.WMS.Controllers
{
    ...
    public class WarehouseareaController : BaseController
    {
        ...
        #region Api
        /// <summary>
        /// get warehousearea  select items by WarehouseId
        /// </summary>
        /// <returns></returns>
        [HttpGet("areas-by-WarehouseId")]
        public async Task<ResultModel<List<FormSelectItem>>> GetSelectItemsAsnyc(int WarehouseId)
        {
            var datas = await _warehouseareaService.GetWarehouseareaByWarehouseId(WarehouseId, CurrentUser);
        ...
        [HttpGet("all")]
        public async Task<ResultModel<List<WarehouseareaViewModel>>> GetAllAsync(int WarehouseId)
        {
            var data = await _warehouseareaService.GetAllAsync(WarehouseId, CurrentUser);
            if (data.Any())
            {
