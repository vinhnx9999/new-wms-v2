...
namespace WMSSolution.WMS.Controllers
{
    ...
    public class SpuController : BaseController
    {
        ...
        /// <param name="skuService">sku Service</param>
        ...
        /// </summary>
        /// <returns></returns>
        [HttpPost("sku-uom-list")]
        public async Task<ResultModel<List<SkuUomDTO>>> GetSkuUomListAsync()
        {
            var data = await _skuService.GetAllSkuUomsAsync(CurrentUser.tenant_id);
            return ResultModel<List<SkuUomDTO>>.Success(data);
        }
        #endregion
    }
}
